...
const CourtComponent = ({ name, price, slots, location, type, level, images = [], applied_players, players_needed, time, contact_info, applied_count, idCourt }) => { // Added time here
