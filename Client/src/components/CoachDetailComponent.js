                ...
                <Row>
                    ...
                    <Col md={5} className="court-details">
                        <Card.Body id='court-card-body'>
                            ...
                            <Card.Text>
                                <CiMedal className="icon" style={{ color: "#828282", fontSize: "20px" }} />Thành tích nổi bật: {description}
                            </Card.Text>
                            <Card.Text>
                                <div className="icon" style={{ color: "#828282" }} />Số điện thoại: {contact?.phone}
                            </Card.Text>
