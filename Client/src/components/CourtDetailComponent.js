        ...
        <Card className="court-detail-card">
          <Row style={{ margin: 0 }}>
            ...
            <Col md={6} style={{ padding: 0 }}>
              <img src={process.env.PUBLIC_URL + '/assets/images/Register.png'} style={{ height: '80%', width: '80%' }}/>
              {/* Image Gallery */}
            ...
            {/* Court Details */}
            <Col md={6} className="court-details" style={{ padding: 0 }}>
