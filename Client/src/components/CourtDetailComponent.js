          ...
          <Col md={5} className="court-details">
            <Card.Body>
              ...
              <Card.Text className="text-location">
                <FaMapMarkerAlt className="icon" style={{ color: "#828282" }} />
                <a
                  href={courtLocation}
                  target="_blank"
              ...
              <Card.Text>
                <FaUserFriends className="icon" style={{ color: "#064D7E" }} />{" "}
                {applied_players}/{players_needed} người đã đăng ký
              </Card.Text>
              <Card.Text>
                <FaRegClock className="icon" style={{ color: "#064D7E" }} />{" "}
                {slots} slot còn lại
              </Card.Text>
              <Card.Text
                style={{
